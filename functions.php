...
/** Tell WordPress to run thune_setup() when the 'after_setup_theme' hook is run. */
add_action( 'after_setup_theme', 'thune_setup' );
 
if ( ! function_exists( 'thune_setup' ) ):
function thune_setup() {
	...
	add_image_size( 'full-thumbnail', 992, 400, true );
...
add_action( 'widgets_init', 'thune_widgets_init' );


if ( ! function_exists( 'thune_posted_on' ) ) :
/**
